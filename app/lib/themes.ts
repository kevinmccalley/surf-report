...
export const THEMES: Theme[] = [
  { id: 'ocean',       name: 'Ocean',       dark: true,  preview: ['#020917', '#0d2040', '#0d2040'] },
  { id: 'sunset',      name: 'Rust',        dark: true,  preview: ['#180a03', '#3d1c0a', '#3d1c0a'] },
  { id: 'forest',      name: 'Kelp',        dark: true,  preview: ['#020d04', '#0b200f', '#0b200f'] },
  { id: 'sand',        name: 'Sand',        dark: true,  preview: ['#120f05', '#28210c', '#28210c'] },
