  ...
  try {
    ...
    for (let h = 0; h < 24; h++) {
      ...
      hourly.push({
        ...
        swellPeriod: isCoastal && mIdx >= 0 ? val(mh.swell_wave_period, mIdx) : 0,
        swellDirection: isCoastal && mIdx >= 0 ? val(mh.swell_wave_direction, mIdx) : 0,
        windWaveHeight: isCoastal && mIdx >= 0 ? val(mh.wind_wave_height, mIdx) : 0,
        windWavePeriod: isCoastal && mIdx >= 0 ? val(mh.wind_wave_period, mIdx) : 0,
        windWaveDirection: isCoastal && mIdx >= 0 ? val(mh.wind_wave_direction, mIdx) : 0,
        swell2Height: isCoastal && mIdx >= 0 ? val(mh.swell_wave_height_2, mIdx) : 0,
        swell2Period: isCoastal && mIdx >= 0 ? val(mh.swell_wave_period_2, mIdx) : 0,
        swell2Direction: isCoastal && mIdx >= 0 ? val(mh.swell_wave_direction_2, mIdx) : 0,
        swell3Height: isCoastal && mIdx >= 0 ? val(mh.swell_wave_height_3, mIdx) : 0,
        swell3Period: isCoastal && mIdx >= 0 ? val(mh.swell_wave_period_3, mIdx) : 0,
        swell3Direction: isCoastal && mIdx >= 0 ? val(mh.swell_wave_direction_3, mIdx) : 0,
