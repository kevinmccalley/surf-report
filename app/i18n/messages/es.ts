const es: Record<string, string> = {
  ...
  'mktL.lede': 'Groundswell es un servicio de pronóstico de surf: condiciones en vivo y un pronóstico de olas de 10 días para cualquier spot del planeta, más de 4 años de historial de mar de fondo.',
  ...
  'regions.meta.title':                'Regiones de Surf — Groundswell',
  'regions.meta.desc':                 'Explora el mundo por región de surf: Baja Sur, las Mentawai, el País Vasco y más. Cada región reúne sus mejores olas en un solo mapa.',
  'regions.meta.detailDesc':           '{region}: {count} rompientes de surf seleccionadas y reunidas en un mapa, cada una con un pronóstico en vivo en Groundswell.',
  'regions.heading':                   'Regiones de Surf',
  'regions.subtitle':                  'Cada región de surf seleccionada, con sus rompientes reunidas en un solo mapa y un pronóstico en vivo para cada una. Casi 60 regiones —North Shore de Oahu, las Mentawai, el País Vasco y más—, además de un atlas mundial del surf a pantalla completa.',
  'regions.breadcrumb':                'Regiones',
  'regions.searchPlaceholder':         'Buscar regiones…',
  'regions.allContinents':             'Todos los continentes',
  'regions.regionCount':               '{count} regiones',
  'regions.noResults':                 'Ninguna región coincide con tus filtros.',
  'regions.flagshipBadge':             'Muestra gratuita',
  'regions.lockedBadge':               'Bloqueada',
  'regions.detail.spotsHeading':       'Olas de esta región',
  ...
  'regions.map.linkCta':               'Explorar el mapa del mundo',
  'regions.map.meta.title':            'Atlas del Surf — Groundswell',
  'regions.map.meta.desc':             'Un mapa con zoom de todas las regiones de surf seleccionadas. Pasa el cursor para iluminar una, ábrela con un clic y acércate para ver cada ola.',
  'regions.map.heading':               'Atlas del Surf',
  'regions.map.stats':                 '{regions} regiones · {spots} olas',
  'regions.map.hint':                  'Pasa el cursor sobre una región para iluminarla · haz clic para abrirla · acércate para ver las olas',
}
